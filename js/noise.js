/**
 * A simple implementation of 3D value noise. It creates a *noise* object with
 * methods for sampling noise from a 3D value matrix.
 * Run-time performance could still be further improved, with little cost to other
 * complexities.
 */
